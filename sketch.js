...
function setup() {
	...
	packageSprite=createSprite(width/2, 80, 10,100);
	...
	side1Sprite=createSprite(400,665,100,15);
	side1Sprite.shapeColor=color("red");

	side2Sprite=createSprite(350,622,20);
	side2Sprite.shapeColor=color("red");

	side3Sprite=createSprite(450,623,20);
